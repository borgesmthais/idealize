...

{
    ...
    /// </summary>
    public class RespostaDAO : NativeDAO<Resposta>, IBaseDAO<Resposta, int>
    {
        ...
        public RespostaDAO(System.Data.IDbConnection connection, ObjectSecurity objectSecurity) : base(connection, objectSecurity)
        {
        }
        ...
        /// <returns>Objeto Inserido</returns>
        public Resposta InsertByStoredProcedure(Resposta pObject)
        {
            string sql = "dbo.pr_ins_Resposta";
        ...
        public Resposta UpdateByStoredProcedure(Resposta pObject)
        {
            string sql = "dbo.U_sp_Resposta";
            StatementDAO statement = new StatementDAO(sql);
