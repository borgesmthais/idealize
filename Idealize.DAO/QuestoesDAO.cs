...

{
    ...
    public class QuestoesDAO : NativeDAO<Questoes>
    {
        ...
        public QuestoesDAO(System.Data.IDbConnection connection, ObjectSecurity objectSecurity) : base(connection, objectSecurity)
        {
        }
        ...
        /// <returns>Objeto Inserido</returns>
        public Questoes InsertByStoredProcedure(Questoes pObject)
        {
            string sql = "dbo.I_sp_Questoes";
        ...
        public int DeleteByStoredProcedure(Questoes pObject, bool flExclusaoLogica, int userSystem)
        {
            string sql = "dbo.D_sp_Questoes";
            StatementDAO statement = new StatementDAO(sql);
            statement.AddParameter("idQuestao", pObject.idQuestao);
            statement.AddParameter("idQuestionario", pObject.idQuestionario);
            statement.AddParameter("idCampanha", pObject.idCampanha);
        ...
        public Questoes SelectByPK(Questoes pObject)
        {
            string sql = "dbo.S_sp_Questoes";
            StatementDAO statement = new StatementDAO(sql);
            statement.AddParameter("idQuestao", pObject.idQuestao);
            statement.AddParameter("idQuestionario", pObject.idQuestionario);
            statement.AddParameter("idCampanha", pObject.idCampanha);
