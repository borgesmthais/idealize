...

{
    ...
    /// </summary>
    public class TemplateOpcoesDAO : NativeDAO<TemplateOpcoes>, IBaseDAO<TemplateOpcoes, int>
    {
        ...
        public TemplateOpcoesDAO(System.Data.IDbConnection connection, ObjectSecurity objectSecurity) : base(connection, objectSecurity)
        {
        }
        ...
        /// <returns>Objeto Inserido</returns>
        public TemplateOpcoes InsertByStoredProcedure(TemplateOpcoes pObject)
        {
            string sql = "dbo.I_sp_TemplateOpcoes";
        ...
        public TemplateOpcoes UpdateByStoredProcedure(TemplateOpcoes pObject)
        {
            string sql = "dbo.U_sp_TemplateOpcoes";
            StatementDAO statement = new StatementDAO(sql);
            statement.AddParameter("idTemplateOpcao", pObject.idTemplateOpcao);
            statement.AddParameter("idTemplateQuestionario", pObject.idTemplateQuestionario);
            statement.AddParameter("idTemplateQuestao", pObject.idTemplateQuestao);
            statement.AddParameter("Descricao", pObject.descricao);
            return this.ExecuteReturnT(statement);
        ...
        public int DeleteByStoredProcedure(TemplateOpcoes pObject, bool flExclusaoLogica, int userSystem)
        {
            string sql = "dbo.D_sp_TemplateOpcoes";
            StatementDAO statement = new StatementDAO(sql);
            statement.AddParameter("idTemplateOpcao", pObject.idTemplateOpcao);
            statement.AddParameter("idTemplateQuestionario", pObject.idTemplateQuestionario);
            statement.AddParameter("idTemplateQuestao", pObject.idTemplateQuestao);
        ...
        public TemplateOpcoes SelectByPK(TemplateOpcoes pObject)
        {
            string sql = "dbo.S_sp_TemplateOpcoes";
            StatementDAO statement = new StatementDAO(sql);
            statement.AddParameter("idTemplateOpcao", pObject.idTemplateOpcao);
            statement.AddParameter("idTemplateQuestionario", pObject.idTemplateQuestionario);
            statement.AddParameter("idTemplateQuestao", pObject.idTemplateQuestao);
