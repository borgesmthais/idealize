...
namespace Idealize.BO
{
    ...
    /// </summary>
    public class TemplateQuestoesBO : IBaseBO<TemplateQuestoes, int>
    {
        ...
        /// </summary>
        public TemplateQuestoesBO(ObjectSecurity pObjectSecurity) : base()
        {
            TemplateQuestoesDAO = new TemplateQuestoesDAO(ConnectionFactory.GetDbConnectionDefault(), pObjectSecurity);
        ...
        {
            return TemplateQuestoesDAO.SelectByPK(pidTemplateQuestao);
        }
        ...
        public IList<TemplateQuestoes> ListForLookup(TemplateQuestoes pObject)
        {
            return TemplateQuestoesDAO.ListForLookup(pObject);
        }
        ...
        /// <returns>Lista de Objetos que atendam ao filtro</returns>
        public IList<TemplateQuestoes> ListForGrid(TemplateQuestoes pObject, int pNumRegPag, int pNumPagina, string pDesOrdem, out int pNumTotReg)
        {
            return TemplateQuestoesDAO.ListForGrid(pObject, pNumRegPag, pNumPagina, pDesOrdem, out pNumTotReg);
        }
